...
traitName = 'type'
ll = ll.reduce_tree(ll.get_external(lambda k: k.traits[traitName] == 'c'))
...
ax2 = ax.inset_axes([0.1, 0.05, 0.025, 0.5])
...
plt.savefig('reduced-tree-camel.png', bbox_inches='tight')