...
pt = bt_utils.state_collapse_tree(ll, switchFxn=partitionFxn, keepLast=False) ## keeping earliest branch as representative of lineage, adjusting its height to have the date of the last descendant
pt.treeStats()
...
plt.savefig('state-collapsed-tree-earliest.png', bbox_inches='tight')