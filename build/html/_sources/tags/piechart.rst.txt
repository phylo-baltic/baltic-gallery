...
.. raw:: html
   ...
   <div class="gallery-card">
     <div class="gallery-card__imgwrap">
           <a class="gallery-card__image-link" href="../tutorials/basic-tree-piechart.html">
               <img src="../_static/tutorials/basic-tree-piechart.png" alt="basic tree piechart" loading="lazy">
           </a>
       <div class="gallery-card__overlay">
         <a class="gallery-card__title" href="../tutorials/basic-tree-piechart.html">basic tree piechart</a>
       </div>
     </div>
   </div>
   <div class="gallery-card">
